...
public class Login_Signup extends Application {
    ...
    public void start(Stage stage) {
        ...
        HBox buttonBox = createButtons(usernameField, passwordField, loginButton, clearButton, roleBox, homeButton);
    ...
    public HBox createButtons(TextField usernameField, PasswordField passwordField, Button loginButton, Button clearButton, ComboBox<String> roleBox, Button homeButton) {
    ...
    public static void launchLoginSignup(Stage primaryStage) {
        Platform.runLater(() -> {
            ...
            try {
                ...
                loginPage.start(new Stage()); // Or pass the existing stage if needed
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
